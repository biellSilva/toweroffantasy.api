...
class BannersChinaRepository:
    ...
    async def load_data(self) -> None:
        ...
        DATA_PATH = Path("./src/infra/database/china", "banners_china.json")
        WEAPONS_PATH = Path("./src/infra/database/china/cn/", "weapons.json")
        IMITATION_PATH = Path("./src/infra/database/china/cn/", "imitations.json")
